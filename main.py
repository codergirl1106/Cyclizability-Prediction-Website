...
def main():
    ...
    st.markdown("---")
    st.markdown("NOTE: We strongly recommend running the website using .cif file from RCSB PDB when possible. We've noticed some strangely formatted .pdb files, i.e. ATOM line 4517 from 6PW2.")
    st.markdown("---")
    seq = ''
    cords = ''
    pdbcif = ''
